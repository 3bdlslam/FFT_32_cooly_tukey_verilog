...
X_reg[1][1][0]<=MAC_out[0][1][0];
X_reg[1][1][1]<=MAC_out[0][1][1];
X_reg[1][2][0]<=MAC_out[1][0][0];
X_reg[1][2][1]<=MAC_out[1][0][1];
X_reg[1][3][0]<=MAC_out[1][1][0];
X_reg[1][3][1]<=MAC_out[1][1][1];
X_reg[1][4][0]<=MAC_out[2][0][0];
X_reg[1][4][1]<=MAC_out[2][0][1];
X_reg[1][5][0]<=MAC_out[2][1][0];
X_reg[1][5][1]<=MAC_out[2][1][1];
X_reg[1][6][0]<=MAC_out[3][0][0];
X_reg[1][6][1]<=MAC_out[3][0][1];
X_reg[1][7][0]<=MAC_out[3][1][0];
X_reg[1][7][1]<=MAC_out[3][1][1];
X_reg[1][8][0]<=MAC_out[4][0][0];
X_reg[1][8][1]<=MAC_out[4][0][1];
X_reg[1][9][0]<=MAC_out[4][1][0];
X_reg[1][9][1]<=MAC_out[4][1][1];
X_reg[1][10][0]<=MAC_out[5][0][0];
X_reg[1][10][1]<=MAC_out[5][0][1];
X_reg[1][11][0]<=MAC_out[5][1][0];
X_reg[1][11][1]<=MAC_out[5][1][1];
X_reg[1][12][0]<=MAC_out[6][0][0];
X_reg[1][12][1]<=MAC_out[6][0][1];
X_reg[1][13][0]<=MAC_out[6][1][0];
X_reg[1][13][1]<=MAC_out[6][1][1];
X_reg[1][14][0]<=MAC_out[7][0][0];
X_reg[1][14][1]<=MAC_out[7][0][1];
X_reg[1][15][0]<=MAC_out[7][1][0];
X_reg[1][15][1]<=MAC_out[7][1][1];
X_reg[1][16][0]<=MAC_out[8][0][0];
X_reg[1][16][1]<=MAC_out[8][0][1];
X_reg[1][17][0]<=MAC_out[8][1][0];
X_reg[1][17][1]<=MAC_out[8][1][1];
X_reg[1][18][0]<=MAC_out[9][0][0];
X_reg[1][18][1]<=MAC_out[9][0][1];
X_reg[1][19][0]<=MAC_out[9][1][0];
X_reg[1][19][1]<=MAC_out[9][1][1];
X_reg[1][20][0]<=MAC_out[10][0][0];
X_reg[1][20][1]<=MAC_out[10][0][1];
X_reg[1][21][0]<=MAC_out[10][1][0];
X_reg[1][21][1]<=MAC_out[10][1][1];
X_reg[1][22][0]<=MAC_out[11][0][0];
X_reg[1][22][1]<=MAC_out[11][0][1];
X_reg[1][23][0]<=MAC_out[11][1][0];
X_reg[1][23][1]<=MAC_out[11][1][1];
X_reg[1][24][0]<=MAC_out[12][0][0];
X_reg[1][24][1]<=MAC_out[12][0][1];
X_reg[1][25][0]<=MAC_out[12][1][0];
X_reg[1][25][1]<=MAC_out[12][1][1];
X_reg[1][26][0]<=MAC_out[13][0][0];
X_reg[1][26][1]<=MAC_out[13][0][1];
X_reg[1][27][0]<=MAC_out[13][1][0];
X_reg[1][27][1]<=MAC_out[13][1][1];
X_reg[1][28][0]<=MAC_out[14][0][0];
X_reg[1][28][1]<=MAC_out[14][0][1];
X_reg[1][29][0]<=MAC_out[14][1][0];
X_reg[1][29][1]<=MAC_out[14][1][1];
X_reg[1][30][0]<=MAC_out[15][0][0];
X_reg[1][30][1]<=MAC_out[15][0][1];
X_reg[1][31][0]<=MAC_out[15][1][0];
X_reg[1][31][1]<=MAC_out[15][1][1];
end
else if(Sel==1) begin
X_reg[2][0][0]<=MAC_out[0][0][0];
X_reg[2][0][1]<=MAC_out[0][0][1];
X_reg[2][2][0]<=MAC_out[0][1][0];
X_reg[2][2][1]<=MAC_out[0][1][1];
X_reg[2][1][0]<=MAC_out[1][0][0];
X_reg[2][1][1]<=MAC_out[1][0][1];
X_reg[2][3][0]<=MAC_out[1][1][0];
X_reg[2][3][1]<=MAC_out[1][1][1];
X_reg[2][4][0]<=MAC_out[2][0][0];
X_reg[2][4][1]<=MAC_out[2][0][1];
X_reg[2][6][0]<=MAC_out[2][1][0];
X_reg[2][6][1]<=MAC_out[2][1][1];
X_reg[2][5][0]<=MAC_out[3][0][0];
X_reg[2][5][1]<=MAC_out[3][0][1];
X_reg[2][7][0]<=MAC_out[3][1][0];
X_reg[2][7][1]<=MAC_out[3][1][1];
X_reg[2][8][0]<=MAC_out[4][0][0];
X_reg[2][8][1]<=MAC_out[4][0][1];
X_reg[2][10][0]<=MAC_out[4][1][0];
X_reg[2][10][1]<=MAC_out[4][1][1];
X_reg[2][9][0]<=MAC_out[5][0][0];
X_reg[2][9][1]<=MAC_out[5][0][1];
X_reg[2][11][0]<=MAC_out[5][1][0];
X_reg[2][11][1]<=MAC_out[5][1][1];
X_reg[2][12][0]<=MAC_out[6][0][0];
X_reg[2][12][1]<=MAC_out[6][0][1];
X_reg[2][14][0]<=MAC_out[6][1][0];
X_reg[2][14][1]<=MAC_out[6][1][1];
X_reg[2][13][0]<=MAC_out[7][0][0];
X_reg[2][13][1]<=MAC_out[7][0][1];
X_reg[2][15][0]<=MAC_out[7][1][0];
X_reg[2][15][1]<=MAC_out[7][1][1];
X_reg[2][16][0]<=MAC_out[8][0][0];
X_reg[2][16][1]<=MAC_out[8][0][1];
X_reg[2][18][0]<=MAC_out[8][1][0];
X_reg[2][18][1]<=MAC_out[8][1][1];
X_reg[2][17][0]<=MAC_out[9][0][0];
X_reg[2][17][1]<=MAC_out[9][0][1];
X_reg[2][19][0]<=MAC_out[9][1][0];
X_reg[2][19][1]<=MAC_out[9][1][1];
X_reg[2][20][0]<=MAC_out[10][0][0];
X_reg[2][20][1]<=MAC_out[10][0][1];
X_reg[2][22][0]<=MAC_out[10][1][0];
X_reg[2][22][1]<=MAC_out[10][1][1];
X_reg[2][21][0]<=MAC_out[11][0][0];
X_reg[2][21][1]<=MAC_out[11][0][1];
X_reg[2][23][0]<=MAC_out[11][1][0];
X_reg[2][23][1]<=MAC_out[11][1][1];
X_reg[2][24][0]<=MAC_out[12][0][0];
X_reg[2][24][1]<=MAC_out[12][0][1];
X_reg[2][26][0]<=MAC_out[12][1][0];
X_reg[2][26][1]<=MAC_out[12][1][1];
X_reg[2][25][0]<=MAC_out[13][0][0];
X_reg[2][25][1]<=MAC_out[13][0][1];
X_reg[2][27][0]<=MAC_out[13][1][0];
X_reg[2][27][1]<=MAC_out[13][1][1];
X_reg[2][28][0]<=MAC_out[14][0][0];
X_reg[2][28][1]<=MAC_out[14][0][1];
X_reg[2][30][0]<=MAC_out[14][1][0];
X_reg[2][30][1]<=MAC_out[14][1][1];
X_reg[2][29][0]<=MAC_out[15][0][0];
X_reg[2][29][1]<=MAC_out[15][0][1];
X_reg[2][31][0]<=MAC_out[15][1][0];
X_reg[2][31][1]<=MAC_out[15][1][1];
end
else if(Sel==2) begin
X_reg[3][0][0]<=MAC_out[0][0][0];
X_reg[3][0][1]<=MAC_out[0][0][1];
X_reg[3][4][0]<=MAC_out[0][1][0];
X_reg[3][4][1]<=MAC_out[0][1][1];
X_reg[3][1][0]<=MAC_out[1][0][0];
X_reg[3][1][1]<=MAC_out[1][0][1];
X_reg[3][5][0]<=MAC_out[1][1][0];
X_reg[3][5][1]<=MAC_out[1][1][1];
X_reg[3][2][0]<=MAC_out[2][0][0];
X_reg[3][2][1]<=MAC_out[2][0][1];
X_reg[3][6][0]<=MAC_out[2][1][0];
X_reg[3][6][1]<=MAC_out[2][1][1];
X_reg[3][3][0]<=MAC_out[3][0][0];
X_reg[3][3][1]<=MAC_out[3][0][1];
X_reg[3][7][0]<=MAC_out[3][1][0];
X_reg[3][7][1]<=MAC_out[3][1][1];
X_reg[3][8][0]<=MAC_out[4][0][0];
X_reg[3][8][1]<=MAC_out[4][0][1];
X_reg[3][12][0]<=MAC_out[4][1][0];
X_reg[3][12][1]<=MAC_out[4][1][1];
X_reg[3][9][0]<=MAC_out[5][0][0];
X_reg[3][9][1]<=MAC_out[5][0][1];
X_reg[3][13][0]<=MAC_out[5][1][0];
X_reg[3][13][1]<=MAC_out[5][1][1];
X_reg[3][10][0]<=MAC_out[6][0][0];
X_reg[3][10][1]<=MAC_out[6][0][1];
X_reg[3][14][0]<=MAC_out[6][1][0];
X_reg[3][14][1]<=MAC_out[6][1][1];
X_reg[3][11][0]<=MAC_out[7][0][0];
X_reg[3][11][1]<=MAC_out[7][0][1];
X_reg[3][15][0]<=MAC_out[7][1][0];
X_reg[3][15][1]<=MAC_out[7][1][1];
X_reg[3][16][0]<=MAC_out[8][0][0];
X_reg[3][16][1]<=MAC_out[8][0][1];
X_reg[3][20][0]<=MAC_out[8][1][0];
X_reg[3][20][1]<=MAC_out[8][1][1];
X_reg[3][17][0]<=MAC_out[9][0][0];
X_reg[3][17][1]<=MAC_out[9][0][1];
X_reg[3][21][0]<=MAC_out[9][1][0];
X_reg[3][21][1]<=MAC_out[9][1][1];
X_reg[3][18][0]<=MAC_out[10][0][0];
X_reg[3][18][1]<=MAC_out[10][0][1];
X_reg[3][22][0]<=MAC_out[10][1][0];
X_reg[3][22][1]<=MAC_out[10][1][1];
X_reg[3][19][0]<=MAC_out[11][0][0];
X_reg[3][19][1]<=MAC_out[11][0][1];
X_reg[3][23][0]<=MAC_out[11][1][0];
X_reg[3][23][1]<=MAC_out[11][1][1];
X_reg[3][24][0]<=MAC_out[12][0][0];
X_reg[3][24][1]<=MAC_out[12][0][1];
X_reg[3][28][0]<=MAC_out[12][1][0];
X_reg[3][28][1]<=MAC_out[12][1][1];
X_reg[3][25][0]<=MAC_out[13][0][0];
X_reg[3][25][1]<=MAC_out[13][0][1];
X_reg[3][29][0]<=MAC_out[13][1][0];
X_reg[3][29][1]<=MAC_out[13][1][1];
X_reg[3][26][0]<=MAC_out[14][0][0];
X_reg[3][26][1]<=MAC_out[14][0][1];
X_reg[3][30][0]<=MAC_out[14][1][0];
X_reg[3][30][1]<=MAC_out[14][1][1];
X_reg[3][27][0]<=MAC_out[15][0][0];
X_reg[3][27][1]<=MAC_out[15][0][1];
X_reg[3][31][0]<=MAC_out[15][1][0];
X_reg[3][31][1]<=MAC_out[15][1][1];
end
else if(Sel==3) begin
X_reg[4][0][0]<=MAC_out[0][0][0];
X_reg[4][0][1]<=MAC_out[0][0][1];
X_reg[4][8][0]<=MAC_out[0][1][0];
X_reg[4][8][1]<=MAC_out[0][1][1];
X_reg[4][1][0]<=MAC_out[1][0][0];
X_reg[4][1][1]<=MAC_out[1][0][1];
X_reg[4][9][0]<=MAC_out[1][1][0];
X_reg[4][9][1]<=MAC_out[1][1][1];
X_reg[4][2][0]<=MAC_out[2][0][0];
X_reg[4][2][1]<=MAC_out[2][0][1];
X_reg[4][10][0]<=MAC_out[2][1][0];
X_reg[4][10][1]<=MAC_out[2][1][1];
X_reg[4][3][0]<=MAC_out[3][0][0];
X_reg[4][3][1]<=MAC_out[3][0][1];
X_reg[4][11][0]<=MAC_out[3][1][0];
X_reg[4][11][1]<=MAC_out[3][1][1];
X_reg[4][4][0]<=MAC_out[4][0][0];
X_reg[4][4][1]<=MAC_out[4][0][1];
X_reg[4][12][0]<=MAC_out[4][1][0];
X_reg[4][12][1]<=MAC_out[4][1][1];
X_reg[4][5][0]<=MAC_out[5][0][0];
X_reg[4][5][1]<=MAC_out[5][0][1];
X_reg[4][13][0]<=MAC_out[5][1][0];
X_reg[4][13][1]<=MAC_out[5][1][1];
X_reg[4][6][0]<=MAC_out[6][0][0];
X_reg[4][6][1]<=MAC_out[6][0][1];
X_reg[4][14][0]<=MAC_out[6][1][0];
X_reg[4][14][1]<=MAC_out[6][1][1];
X_reg[4][7][0]<=MAC_out[7][0][0];
X_reg[4][7][1]<=MAC_out[7][0][1];
X_reg[4][15][0]<=MAC_out[7][1][0];
X_reg[4][15][1]<=MAC_out[7][1][1];
X_reg[4][16][0]<=MAC_out[8][0][0];
X_reg[4][16][1]<=MAC_out[8][0][1];
X_reg[4][24][0]<=MAC_out[8][1][0];
X_reg[4][24][1]<=MAC_out[8][1][1];
X_reg[4][17][0]<=MAC_out[9][0][0];
X_reg[4][17][1]<=MAC_out[9][0][1];
X_reg[4][25][0]<=MAC_out[9][1][0];
X_reg[4][25][1]<=MAC_out[9][1][1];
X_reg[4][18][0]<=MAC_out[10][0][0];
X_reg[4][18][1]<=MAC_out[10][0][1];
X_reg[4][26][0]<=MAC_out[10][1][0];
X_reg[4][26][1]<=MAC_out[10][1][1];
X_reg[4][19][0]<=MAC_out[11][0][0];
X_reg[4][19][1]<=MAC_out[11][0][1];
X_reg[4][27][0]<=MAC_out[11][1][0];
X_reg[4][27][1]<=MAC_out[11][1][1];
X_reg[4][20][0]<=MAC_out[12][0][0];
X_reg[4][20][1]<=MAC_out[12][0][1];
X_reg[4][28][0]<=MAC_out[12][1][0];
X_reg[4][28][1]<=MAC_out[12][1][1];
X_reg[4][21][0]<=MAC_out[13][0][0];
X_reg[4][21][1]<=MAC_out[13][0][1];
X_reg[4][29][0]<=MAC_out[13][1][0];
X_reg[4][29][1]<=MAC_out[13][1][1];
X_reg[4][22][0]<=MAC_out[14][0][0];
X_reg[4][22][1]<=MAC_out[14][0][1];
X_reg[4][30][0]<=MAC_out[14][1][0];
X_reg[4][30][1]<=MAC_out[14][1][1];
X_reg[4][23][0]<=MAC_out[15][0][0];
X_reg[4][23][1]<=MAC_out[15][0][1];
X_reg[4][31][0]<=MAC_out[15][1][0];
X_reg[4][31][1]<=MAC_out[15][1][1];
end
else begin
X_reg[5][0][0]<=MAC_out[0][0][0];
X_reg[5][0][1]<=MAC_out[0][0][1];
X_reg[5][16][0]<=MAC_out[0][1][0];
X_reg[5][16][1]<=MAC_out[0][1][1];
X_reg[5][1][0]<=MAC_out[1][0][0];
X_reg[5][1][1]<=MAC_out[1][0][1];
X_reg[5][17][0]<=MAC_out[1][1][0];
X_reg[5][17][1]<=MAC_out[1][1][1];
X_reg[5][2][0]<=MAC_out[2][0][0];
X_reg[5][2][1]<=MAC_out[2][0][1];
X_reg[5][18][0]<=MAC_out[2][1][0];
X_reg[5][18][1]<=MAC_out[2][1][1];
X_reg[5][3][0]<=MAC_out[3][0][0];
X_reg[5][3][1]<=MAC_out[3][0][1];
X_reg[5][19][0]<=MAC_out[3][1][0];
X_reg[5][19][1]<=MAC_out[3][1][1];
X_reg[5][4][0]<=MAC_out[4][0][0];
X_reg[5][4][1]<=MAC_out[4][0][1];
X_reg[5][20][0]<=MAC_out[4][1][0];
X_reg[5][20][1]<=MAC_out[4][1][1];
X_reg[5][5][0]<=MAC_out[5][0][0];
X_reg[5][5][1]<=MAC_out[5][0][1];
X_reg[5][21][0]<=MAC_out[5][1][0];
X_reg[5][21][1]<=MAC_out[5][1][1];
X_reg[5][6][0]<=MAC_out[6][0][0];
X_reg[5][6][1]<=MAC_out[6][0][1];
X_reg[5][22][0]<=MAC_out[6][1][0];
X_reg[5][22][1]<=MAC_out[6][1][1];
X_reg[5][7][0]<=MAC_out[7][0][0];
X_reg[5][7][1]<=MAC_out[7][0][1];
X_reg[5][23][0]<=MAC_out[7][1][0];
X_reg[5][23][1]<=MAC_out[7][1][1];
X_reg[5][8][0]<=MAC_out[8][0][0];
X_reg[5][8][1]<=MAC_out[8][0][1];
X_reg[5][24][0]<=MAC_out[8][1][0];
X_reg[5][24][1]<=MAC_out[8][1][1];
X_reg[5][9][0]<=MAC_out[9][0][0];
X_reg[5][9][1]<=MAC_out[9][0][1];
X_reg[5][25][0]<=MAC_out[9][1][0];
X_reg[5][25][1]<=MAC_out[9][1][1];
X_reg[5][10][0]<=MAC_out[10][0][0];
X_reg[5][10][1]<=MAC_out[10][0][1];
X_reg[5][26][0]<=MAC_out[10][1][0];
X_reg[5][26][1]<=MAC_out[10][1][1];
X_reg[5][11][0]<=MAC_out[11][0][0];
X_reg[5][11][1]<=MAC_out[11][0][1];
X_reg[5][27][0]<=MAC_out[11][1][0];
X_reg[5][27][1]<=MAC_out[11][1][1];
X_reg[5][12][0]<=MAC_out[12][0][0];
X_reg[5][12][1]<=MAC_out[12][0][1];
X_reg[5][28][0]<=MAC_out[12][1][0];
X_reg[5][28][1]<=MAC_out[12][1][1];
X_reg[5][13][0]<=MAC_out[13][0][0];
X_reg[5][13][1]<=MAC_out[13][0][1];
X_reg[5][29][0]<=MAC_out[13][1][0];
X_reg[5][29][1]<=MAC_out[13][1][1];
X_reg[5][14][0]<=MAC_out[14][0][0];
X_reg[5][14][1]<=MAC_out[14][0][1];
X_reg[5][30][0]<=MAC_out[14][1][0];
X_reg[5][30][1]<=MAC_out[14][1][1];
X_reg[5][15][0]<=MAC_out[15][0][0];
X_reg[5][15][1]<=MAC_out[15][0][1];
X_reg[5][31][0]<=MAC_out[15][1][0];
X_reg[5][31][1]<=MAC_out[15][1][1];
end
end
